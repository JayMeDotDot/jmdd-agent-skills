...
| [github-issue-creator](./skills/github-issue-creator/SKILL.md) | Use this skill when asked to create a GitHub issue. It handles different issue types (bug, feature, etc.) using repository templates and ensures proper labeling. |
| [improve-seo](./skills/improve-seo/SKILL.md) | Help to improve SEO of a website. |
| [pr-creator](./skills/pr-creator/SKILL.md) | Use this skill when asked to create a pull request (PR). It ensures all PRs follow the repository's established templates and standards. |
| [prd-creator](./skills/prd-creator/SKILL.md) | Create high-quality Product Requirement Document (PRD), following the standard PRD format. Use when the user asks to create, write, generate, or update a PRD. |
